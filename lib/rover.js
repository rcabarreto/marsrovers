...
Rover.prototype.getAlternateCourse = function (plateau, x, y, o) {
  let newPath = 'LMRMMRML';
  if ((o === 'N' && x === 0) || (o === 'S' && x === plateau.x) || (o === 'E' && y === 0) || (o === 'W' && y === plateau.y)) {
    newPath = 'RMLMMLMR';
  }
  return newPath;
};
...
Rover.prototype.goAround = function () {
  ...
  if (this.path[pathPosition+1] === 'M') {
    ...
    let newPath = this.getAlternateCourse(this.plateau, this.x, this.y, this.o);
